...
# BELOW will work the SAME as long as they JOIN the other one.
...
SELECT employees.first_name, titles.title, salaries.salary FROM salaries  #Show me three different columns from salaries table
JOIN employees on salaries.emp_no = employees.emp_no #join employees table by connecting employee number from salaries & employees
JOIN titles on employees.emp_no = titles.emp_no; #join titles table by connecting employee number from employees & titles


# Aliases version
SELECT e.first_name, t.title, s.salary FROM salaries AS s  #Show me three different columns from salaries table
JOIN employees AS e on s.emp_no = e.emp_no #join employees table by connecting employee number from salaries & employees
JOIN titles AS t on e.emp_no = t.emp_no; #join titles table by connecting employee number from employees & titles


SELECT titles.title, salaries.salary FROM titles  #Show me three different columns from salaries table
